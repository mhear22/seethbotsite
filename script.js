...
// Rankings panel toggle
let rankingsOpen = true;
document.getElementById('rankingsToggle').addEventListener('click', function() {
  rankingsOpen = !rankingsOpen;
  const rankingsPanel = document.getElementById('rankingsPanel');
  if (rankingsPanel) {
    rankingsPanel.classList.toggle('collapsed', !rankingsOpen);
  }
});

// Mika button/modal
document.getElementById('mikaBtn').addEventListener('click', function() {
  const mikaModal = document.getElementById('mikaModal');
  if (mikaModal) {
    mikaModal.classList.add('active');
  }
});

document.getElementById('mikaClose').addEventListener('click', function() {
  const mikaModal = document.getElementById('mikaModal');
  if (mikaModal) {
    mikaModal.classList.remove('active');
  }
});
